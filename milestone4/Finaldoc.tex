...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{totbitcoinstradevolFig7.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{rules2plotFig10.png}
...
\end{figure}
 ...
 \begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{AntecedentConsequentFig11.png}
